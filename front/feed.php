  ...
  <section class="pulsar-hero card-u">
    ...
    <div class="pulsar-actions">
      <a href="<?php echo htmlspecialchars($idea_form_url); ?>" class="btn-u primary">
        <i class="fa-solid fa-lightbulb"></i> Nova Ideia
      </a>
      
      <?php if ($can_admin): ?>
      <a href="<?php echo htmlspecialchars($campaign_form_url); ?>" class="btn-u secondary">
        <i class="fa-solid fa-flag"></i> Nova Campanha
      </a>
      <?php endif; ?>
    </div>
  </section>
...
<article class="campanha card-u highlight" data-title="<?php echo htmlspecialchars($campaign['name']); ?>">
  <div class="campanha-header">
    ...
    <button class="share share-campaign-btn" 
            ...
            data-campaign-url="<?php echo $CFG_GLPI['root_doc']; ?>/plugins/agilizepulsar/front/campaign.php?id=<?php echo $campaign['id']; ?>">
      ...
      <section class="ideas">
        ...
        <div class="idea-card card-u">
          ...
          <div class="idea-meta pulsar-muted">
            ...
            ?> • <?php echo Html::convDate($idea['date']); ?>
          </div>
          <div class="idea-foot">
