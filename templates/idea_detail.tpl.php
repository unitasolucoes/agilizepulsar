...
$author_user->getFromDB($data['users_id_recipient'] ?? 0);

$author_name = $author_user->getFriendlyName();
$author_initials = PluginAgilizepulsarConfig::getUserInitials(
    $author_user->fields['firstname'] ?? '', 
    $author_user->fields['realname'] ?? ''
);
?>
