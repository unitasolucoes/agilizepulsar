      ...
      <div class="idea-title-section">
        ...
        <div class="idea-meta">
          ...
          <div class="idea-stats">
            <span class="stat-item"><i class="fa-solid fa-heart"></i> <span id="likes-count"><?php echo (int) $campaign['likes_count']; ?></span></span>
            <span class="stat-item"><i class="fa-solid fa-comment"></i> <?php echo (int) $campaign['comments_count']; ?></span>
            <span class="stat-item"><i class="fa-solid fa-eye"></i> <?php echo (int) $campaign['views_count']; ?></span>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="status-info">
              ...
              <div class="status-item">
                ...
                <div>
                  ...
                  <div class="pulsar-muted small"><?php echo (int) $campaign['views_count']; ?></div>
                </div>
              </div>
              <div class="status-item">
                ...
                <div>
                  ...
                  <div class="pulsar-muted small"><span id="sidebar-likes-count"><?php echo (int) $campaign['likes_count']; ?></span></div>
                </div>
              </div>
            </div>

            <div class="idea-actions">
              <button class="btn-u primary full-width" id="btn-like" data-ticket="<?php echo (int) $tickets_id; ?>" data-liked="<?php echo $campaign['has_liked'] ? '1' : '0'; ?>" data-can-like="<?php echo $can_like ? '1' : '0'; ?>" <?php echo $can_like ? '' : 'disabled'; ?>>
              ...
              <div class="linked-ideas-list">
                ...
                <div class="linked-idea-card">
                  ...
                  <div class="idea-mini-stats">
                    <span><i class="fa-solid fa-heart"></i> <?php echo (int) $idea['likes_count']; ?></span>
                    <span class="badge info small"><?php echo Ticket::getStatus($idea['status']); ?></span>
                  </div>
                  <a href="idea.php?id=<?php echo (int) $idea['id']; ?>" class="btn-outline btn-small full-width">
...
<style>
  ...
  .idea-status-badge.active{background:#e6efff;color:#1e40af}
