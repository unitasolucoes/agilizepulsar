...
function plugin_agilizepulsar_install() {
    ...
    if (!$DB->tableExists('glpi_plugin_agilizepulsar_rankingconfig')) {
        ...
        $defaults = [
            ['action_type' => 'submitted_idea', 'points_value' => 10, 'is_active' => 1],
            ['action_type' => 'approved_idea', 'points_value' => 50, 'is_active' => 1],
            ['action_type' => 'like', 'points_value' => 2, 'is_active' => 1],
            ['action_type' => 'comment', 'points_value' => 5, 'is_active' => 1],
            ['action_type' => 'implemented_idea', 'points_value' => 100, 'is_active' => 1]
        ];
