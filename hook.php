...
function plugin_agilizepulsar_install() {
    ...
    if (!$DB->tableExists('glpi_plugin_agilizepulsar_idea_campaigns')) {
        $query = "CREATE TABLE `glpi_plugin_agilizepulsar_idea_campaigns` (
...
function plugin_agilizepulsar_uninstall() {
    ...
    $tables = [
        ...
        'glpi_plugin_agilizepulsar_idea_campaigns'
    ];
